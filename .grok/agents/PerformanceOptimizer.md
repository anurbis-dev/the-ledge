...
description: >
  Use when: оптимизируй код, профилирование, производительность, тормозит, фризы, просадки
  FPS, лагает canvas, утечка памяти на большой карте. Performance specialist for the
  LEDGE: rAF loop, chunk cache, light multiply, entity step. Analyze and recommend only —
