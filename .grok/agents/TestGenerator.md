...
name: TestGenerator
description: >
  Use when: написать тесты, тестирование, покрытие, напиши тест для, проверить вручную. QA
  specialist for the LEDGE: structured manual / browser-console checklists
  (chrome-devtools evaluate_script on GAME).
prompt_mode: full
model: inherit
