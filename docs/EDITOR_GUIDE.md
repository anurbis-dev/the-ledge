...
- Героиня / враги: внизу палитры Tiles секция Sprites. Каждая анимация — своя строка кадров; высота полосы — одна строка, сепаратор увеличивает. Клик по кадру — правка пикселей. Неправленные кадры в игре рисуются как раньше.
