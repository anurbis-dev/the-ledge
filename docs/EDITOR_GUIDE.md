...
- Спрайты (героиня, враги, птицы, пауки, NPC): секция Sprites в палитре Tiles, или даблклик по объекту. Каждая анимация — **одна строка кадров** (не куча). Полоса по умолчанию высотой в одну строку; сепаратор под ней тянется вниз, чтобы видеть больше рядов. СКМ-драг / колесо панорамируют строки без полосы прокрутки. Клик по кадру открывает его в том же пиксельном редакторе. Reset frame забывает правку — в игре снова старый рисунок. Пока кадр не красили, игра не переключается на спрайт.
...
- Героиня / враги: внизу палитры Tiles секция Sprites. Каждая анимация — своя строка кадров; высота полосы — одна строка, сепаратор увеличивает. Клик по кадру — правка пикселей. На кадре: голубой круг — якорь привязки к миру, пурпурный квадрат — рука/оружие; оба можно тащить или править числами. Size — ширина×высота кадра. Неправленные кадры в игре рисуются как раньше.
