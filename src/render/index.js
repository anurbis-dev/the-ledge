export { cv, ctx, VW, VH, BUF_W, BUF_H, RENDER_SCALE, setViewport, onViewportChange, deviceScale, applyWorldTransform, clearFrame, hv, viewBox, cam, view, rc, viewScale, setViewScale, viewW, viewH, paintHud, clearHud } from './ctx.js';
...
export { plats, lifts, caveExit, doors, chests, lootDrops, items, pickables, drawTorches, drawHarpoons, drawArrows, enemies, spiders, fliers, tendrils, ropes, boulders, npcs, vehicles } from './sprites.js';
