...
/* кирка — замах в стену впереди: заброс над плечом → удар на уровне груди → провод */
export const DIG0 = po({head:[5,3],neck:[5,7],hip:[5,14],eF:[6,2],hF:[4,-3],eB:[5,10],hB:[6,13],kF:[7,18],fF:[8,22],kB:[3,18],fB:[2,22]});
export const DIG1 = po({head:[5,5],neck:[5,9],hip:[5,15],eF:[9,10],hF:[14,11],eB:[4,12],hB:[3,15],kF:[8,18],fF:[9,22],kB:[3,17],fB:[2,21]});
export const DIG2 = po({head:[5,6],neck:[5,10],hip:[5,16],eF:[9,13],hF:[13,17],eB:[3,13],hB:[2,16],kF:[7,18],fF:[8,22],kB:[3,18],fB:[2,22]});
/* кирка — замах в пол впереди: тот же заброс, удар вниз-вперёд к ногам */
export const DIGD0 = DIG0;
export const DIGD1 = po({head:[6,9],neck:[6,12],hip:[5,15],eF:[9,16],hF:[13,20],eB:[3,14],hB:[2,17],kF:[8,18],fF:[9,22],kB:[3,17],fB:[2,21]});
export const DIGD2 = po({head:[6,10],neck:[6,13],hip:[5,16],eF:[9,17],hF:[12,21],eB:[3,15],hB:[2,18],kF:[7,18],fF:[8,22],kB:[3,18],fB:[2,22]});
