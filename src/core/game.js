...
import { mkVehicles, mkVehicleAt } from '../entities/vehicles.js';
...
export function mkWorld(li){
  runtime.mountSkin = null;       // новый мир — сбросить оверрайд скина от посадки в транспорт прошлого уровня/жизни
  ...
  var w = {
    ...
    emitters: mkEmitters(),
    boulders: mkBoulders(), vehicles: mkVehicles(), npcs: mkNpcs(), burnt: {}, plankT: {}, giveT: {},
...
export const GAME = {
  ...
  mkLightAt, mkSoundAt, mkVolumeAt, mkEmitterAt, mkBoulderAt, mkVehicleAt, mkNpcAt, getLayers, getActiveLayer,
